...
# Install and Enable the CHRONY (Substitute of NTP SYSTEM)
#
PACKAGES_6="atop bc.x86_64 beakerlib-vim-syntax binutils bind-utils bzip2-devel.x86_64 bzip2-libs.x86_64 bzip2.x86_64 chrony cpp compat-libstdc++-33 compat-libcap1 dialog elinks elfutils-libelf elfutils-libelf-devel epel-release.noarch firefox gcc gcc-c++ glances glibc glibc-common glibc-devel glibc-headers htop iotop iptraf-ng iscsi-initiator-utils iscsi-initiator-utils-iscsiuio lsscsi libiscsi netbsd-iscsi targetcli ksh libaio libaio-devel libgcc libstdc++ libstdc++-devel libiscsi libXtst libXtst-devel compat-glibc.x86_64 compat-glibc-headers.x86_64 glibc.i686 glibc.x86_64 glibc-devel.i686 glibc-devel.x86_64 glibc-headers.x86_64 glibc-static.i686 glibc-static.x86_64 glibc-utils.x86_64 libXp.i686 libXp.x86_64 libXp-devel.i686 libXp-devel.x86_64 libXpm.i686 libXpm.x86_64 libXpm-devel.i686 libXpm-devel.x86_64 libXtst.i686 libXtst.x86_64 libXtst-devel.i686 libXtst-devel.x86_64 lm_sensors lsof make mlocate nawk.x86_64 net-tools ntp nfs-utils neofetch nmap policycoreutils-python perl perl-DBI perl-TermReadKey perl-ExtUtils-MakeMaker perl-CPAN perl-CGI perl-URI.noarch psmisc readline-devel rlwrap smartmontools smem sos sysstat strace telnet tmux tuned tuned-utils unixODBC unixODBC-devel unzip vim-X11 vim-common vim-enhanced vim-filesystem vim-minimal wget xorg-x11-server-Xorg xorg-x11-server-common xorg-x11-utils xorg-x11-apps xorg-x11-xauth xterm.x86_64 xsos rsar"
PACKAGES_7="atop bc.x86_64 beakerlib-vim-syntax binutils bind-utils bzip2-devel.x86_64 bzip2-libs.x86_64 bzip2.x86_64 chrony cpp compat-libstdc++-33 compat-libcap1 dialog elinks elfutils-libelf elfutils-libelf-devel epel-release.noarch firefox gcc gcc-c++ glances glibc glibc-common glibc-devel glibc-headers htop iotop iptraf-ng iscsi-initiator-utils iscsi-initiator-utils-iscsiuio lsscsi libiscsi netbsd-iscsi targetcli ksh libaio libaio-devel libgcc libstdc++ libstdc++-devel libiscsi libXtst libXtst-devel lm_sensors lsof make mlocate nawk.x86_64 net-tools ntp nfs-utils neofetch nmap policycoreutils-python perl perl-DBI perl-TermReadKey perl-ExtUtils-MakeMaker perl-CPAN perl-CGI perl-URI.noarch psmisc readline-devel rlwrap smartmontools smem sos cockpit sysstat strace telnet tmux tuned tuned-utils unixODBC unixODBC-devel unzip vim-X11 vim-common vim-enhanced vim-filesystem vim-minimal wget xorg-x11-server-Xorg xorg-x11-server-common xorg-x11-utils xorg-x11-apps xorg-x11-xauth xterm.x86_64 whois xsos rsar"
PACKAGES_8="atop bc.x86_64 binutils bind-utils bzip2-devel.x86_64 bzip2-libs.x86_64 bzip2.x86_64 chrony cpp elfutils-libelf elfutils-libelf-devel firefox gcc gcc-c++ glances glibc glibc-common glibc-devel glibc-headers iotop iptraf-ng iscsi-initiator-utils iscsi-initiator-utils-iscsiuio lsscsi libiscsi targetcli ksh libaio libaio-devel libgcc libnsl libstdc++ libstdc++-devel libiscsi libXtst libXtst-devel lm_sensors lsof make mlocate ncurses.x86_64 ncurses-libs.x86_64 ncurses-libs.x86_64 ncurses-c++-libs.x86_64 ncurses-compat-libs.x86_64 ncurses-devel.x86_64 ncurses-base.noarch ncurses-term.noarch ncurses-base.noarch net-tools nfs-utils neofetch nmap policycoreutils.x86_64 perl perl-DBI perl-TermReadKey perl-ExtUtils-MakeMaker perl-CPAN perl-CGI perl-URI.noarch psmisc readline-devel rlwrap smartmontools smem sos cockpit sysstat strace telnet tmux tuned tuned-utils unixODBC unixODBC-devel unzip vim-X11 vim-common vim-enhanced vim-filesystem vim-minimal wget xorg-x11-server-Xorg xorg-x11-server-common xorg-x11-utils xorg-x11-xauth xterm.x86_64 whois" # xsos rsar
PACKAGES_9="atop bc.x86_64 binutils bind-utils bzip2-devel.x86_64 bzip2-libs.x86_64 bzip2.x86_64 chrony cpp elfutils-libelf elfutils-libelf-devel firefox gcc gcc-c++ glances glibc glibc-common glibc-devel glibc-headers iotop iptraf-ng iscsi-initiator-utils iscsi-initiator-utils-iscsiuio lsscsi libiscsi targetcli ksh libaio libaio-devel libgcc libnsl libstdc++ libstdc++-devel libiscsi libXtst libXtst-devel lm_sensors lsof make mlocate ncurses.x86_64 ncurses-libs.x86_64 ncurses-libs.x86_64 ncurses-c++-libs.x86_64 ncurses-devel.x86_64 ncurses-base.noarch ncurses-term.noarch ncurses-base.noarch net-tools nfs-utils neofetch nmap policycoreutils-python-utils policycoreutils.x86_64 perl perl-DBI perl-TermReadKey perl-ExtUtils-MakeMaker perl-CPAN perl-CGI perl-URI.noarch psmisc readline-devel rlwrap smartmontools smem sos cockpit sysstat strace telnet tmux tuned tuned-utils unixODBC unzip vim-X11 vim-common vim-enhanced vim-filesystem vim-minimal wget xorg-x11-server-Xorg xorg-x11-server-common xorg-x11-utils xorg-x11-xauth xterm.x86_64 whois " # xsos rsar
#
if [[ ${OS_VERSION} == "6".* ]]; then 
  ...
  if [[ $(rpm -q --qf '%{NAME}-%{VERSION}-%{RELEASE} (%{ARCH})\n' ${PACKAGES_9} | egrep "is not installed" | wc -l) != 0 ]]; then
...
# Setup /etc/hosts
#
if [[ $(cat /etc/hosts | egrep -i "$(hostname)" | wc -l) == 0 ]]; then
cat >> /etc/hosts <<EOF
#
$(ip a | egrep -v "inet6|127.0.0.1" | egrep "inet" | awk '{ print $2 }' | cut -f1 -d '/')   $(hostname)   $(hostname -s)
EOF
else
  echo " -- The hosts is already configured --"
fi
#
# ------------------------------------------------------------------------
# Disable SELINUX
...
PRC=3000
PROC=$(echo "${PRC} + 50" | bc)  
MEM=$(free | egrep -i "Mem:" | awk '{ print $2 }'); MEM_G=$(free -g | egrep -i "Mem:" | awk '{ print $2 }')
SGA=$(echo "${MEM} * ${PCT} / 100" | bc); SGA_G=$(echo "${MEM_G} * ${PCT} / 100" | bc)
PGA=$(echo "${SGA} * 10 / 100" | bc); PGA_G=$(echo "${SGA_G} * 10 / 100" | bc)
MAX=$(echo "${SGA} * 1024 * 1024 * 1024" | bc)
MNI=4096
ALL=$(echo "(${SGA} * 1024 * 1024 * 1024) / ${MNI}" | bc)
HPG=$(echo "(${SGA} * 1024 * 1024 * 1024) / 2048 / 1024 / 1024" | bc)
#
echo -e "
Option           |Value
---------------- +------------------------
...
ALTER SYSTEM SET user_larg_pages = ONLY SID = '*' SCOPE = SPFILE;  ---> To Enable Hugepges on the database"
#
...
/usr/sbin/useradd -u 54322 -g oinstall -G oinstall,dba,oper,backupdba,asmdba,dgdba,kmdba,racdba,racoper oracle
#
/usr/sbin/usermod -u 54321 -g oinstall -G oinstall,dba,asmdba,asmadmin,asmoper,racdba,racoper grid
/usr/sbin/usermod -u 54322 -g oinstall -G oinstall,dba,oper,backupdba,asmdba,dgdba,kmdba,racdba,racoper oracle
#
# ------------------------------------------------------------------------
...
if [[ $(cat /etc/fstab | egrep -i "tmpfs" | wc -l) == 0 ]]; then
  ...
  echo " -- The tmpfs is already configured --"
fi
#
# ------------------------------------------------------------------------
