...
SoftwareVersion="3.2.15"
DateCreation="25/01/2011"
DateModification="15/11/2021"
...
crosscheck controlfilecopy tag='${Global_Name}_ControlFile';
quit;
EOF
SepLine                                                                                                                 >> ${LogFile}
...
delete noprompt expired controlfilecopy tag='${Global_Name}_ControlFile';
delete noprompt expired backup of controlfile tag='${Global_Name}_ControlFile';
# delete noprompt controlfilecopy tag='${Global_Name}_ControlFile';
quit;
EOF
SepLine                                                                                                               >> ${LogFile}
...
DirRemote=""                                                                  #
DirScripts=/backup/scripts                                                    # Directory of Scripts
...
#
# Crosscheck & Clean Up
00 00 * * * /backup/scripts/backup.sh XE CleanAll         >> /backup/scripts/logs/CleanAll.log 2>&1

# Backup Full of Database Using RMAN
30 22 * * * /backup/scripts/backup.sh XE FullArchAll      >> /backup/scripts/logs/FullArchAll.log 2>&1
30 02 * * * /backup/scripts/backup.sh XE FullArchAllClean >> /backup/scripts/logs/AullArchAllClean.log 2>&1

# Backup Archivelog All of Database Using RMAN
00,15,30,45 * * * * /backup/scripts/backup.sh XE ArchAll      >> /backup/scripts/logs/ArchAll.log 2>&1
30 00 * * *         /backup/scripts/backup.sh XE ArchAllClean >> /backup/scripts/logs/ArchAllClean.log 2>&1

# Backup Tablespace SYSTEM of Database Using RMAN
20 * * * * /backup/scripts/backup.sh XE TBS system >> /backup/scripts/logs/TBS_system.log 2>&1
40 * * * * /backup/scripts/backup.sh XE TBS sysaux >> /backup/scripts/logs/TBS_sysaux.log 2>&1

# Backup Copy Database
10 * * * *  /backup/scripts/backup.sh XE CopyDB      >> /backup/scripts/logs/CopyDB.log 2>&1
10 21 * * * /backup/scripts/backup.sh XE CopyDBClean >> /backup/scripts/logs/CopyDBClean.log 2>&1

# Backup Copy Datafiles
50 * * * *  /backup/scripts/backup.sh XE CopyDF 1    >> /backup/scripts/logs/CopyDF_1.log 2>&1
55 * * * *  /backup/scripts/backup.sh XE CopyDF 5    >> /backup/scripts/logs/CopyDF_5.log 2>&1
50 21 * * * /backup/scripts/backup.sh XE CopyDFClean >> /backup/scripts/logs/CopyDFClean.log 2>&1

# Backup PDB XEPDB1 of Database Using RMAN
45 * * * * /backup/scripts/backup.sh XE PDB xepdb1 >> /backup/scripts/logs/PDB_xepdb1.log 2>&1
45 * * * * /backup/scripts/backup.sh XE PDBClean   >> /backup/scripts/logs/PDB_xepdb1_Clear.log 2>&1
