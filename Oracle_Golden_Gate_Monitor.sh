...
SepLine
#
echo "STAGE: $(df -h ${OGG_HOME} | grep -v -i "filesystem" | awk '{ print $6 }') | \
TOTAL: $(df -h ${OGG_HOME} | grep -v -i "filesystem" | awk '{ print $2 }') | \
USED: $(df -h ${OGG_HOME} | grep -v -i "filesystem" | awk '{ print $3, $5 }') | \
FREE: $(df -h ${OGG_HOME} | grep -v -i "filesystem" | awk '{ print $4 }')"
#
SepLine
#
sleep 15
